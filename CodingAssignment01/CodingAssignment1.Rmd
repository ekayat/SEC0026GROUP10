...
## I have tried two ways to solve this. The first uses coefficients from the previous equation, the second is a prediction model that includes the confidence interval. I believe the second method to be correct. 
```{r q4}
